...
@rem ##########################################################################
@rem
@rem  gremlins_scaffold startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and GREMLINS_SCAFFOLD_OPTS to pass JVM options to this script.
...
:fail
rem Set variable GREMLINS_SCAFFOLD_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%GREMLINS_SCAFFOLD_EXIT_CONSOLE%" exit 1
exit /b 1
